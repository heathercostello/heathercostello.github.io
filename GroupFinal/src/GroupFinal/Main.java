...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\nWelcome to Costello's GroupFinal.Pizza Parlor,");
        System.out.println("The Cleanest* Student-Run GroupFinal.Pizza Parlor on Campus");
        ...
        System.out.println("Our available GroupFinal.Pizza's and their Prices today are: ");
        ...
        //Adds the specifications for each pizza STILL NEEDS WORK

        Menu menu = new Menu();

        cheese ThinCrust = new cheese("Thin Crust");
        supreme HandTossed = new supreme("Hand Tossed");
        meatLovers DeepDish = new meatLovers("Deep Dish");
        pepperoni GarlicCrust = new pepperoni("Garlic Crust");
        margarita StoneCookedCrust = new margarita("Stone Cooked Crust");
        BbqChicken PepperCrust = new BbqChicken("Pepper Crust");

        ThinCrust.setPrice(7.95);

        menu.addItem(ThinCrust);
        ...
        while (finish < 1) {
            ...
            System.out.println("\nWould you like to order any other pizza's?");
            System.out.print("Please type 1 for yes or any other number for no. ");
        ...
        //Writes the order to a file

        //Reads the order from the file as the receipt

        //Prints closing signature lines.
        System.out.println(" ");
        System.out.println("Thank you for Buying from Costello's GroupFinal.Pizza Parlor!");
        System.out.println("You will be redirected momentarily to our Secured Payment Processor and your order will be sent to the Costello's GroupFinal.Pizza Parlor for processing!");
